    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-500">
          Here's how your pre-test and final test compare, with model answers.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p
              className={`text-3xl font-bold ${improved ? 'text-green-600' : same ? 'text-gray-500' : 'text-red-500'}`}
            >
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-indigo-600">
              {final_score}
              <span className="text-indigo-300 text-xl">/{total}</span>
            </p>
          </div>
        </div>
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div
          className={`rounded-lg p-3 border ${pre_correct ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}
        >
        ...
        <div
          className={`rounded-lg p-3 border ${final_correct ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}
        >
          <p className="text-xs font-semibold uppercase tracking-wide mb-1 text-gray-500">
            Final test
          </p>
